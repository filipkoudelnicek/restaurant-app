                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Mistři v kuchyni</h5>
                                <p>Naši šéfkuchaři jsou mistři ve svém oboru, kteří vytvářejí pokrmy plné chuti a elegance. Přijďte se přesvědčit sami.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Kvalita na talíři</h5>
                                <p>Vychutnejte si jídlo připravené z nejkvalitnějších surovin, které jsou pečlivě vybrány pro váš dokonalý zážitek.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Rezervace stolu</h5>
                                <p>Rezervujte si stůl snadno a rychle online a užijte si pohodlí při plánování vaší návštěvy u nás.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <h5>Podpora</h5>
                                <p>Naše podpora je tu pro vás kdykoliv. Máte dotaz k rezervaci nebo chcete poradit s výběrem? Rádi vám pomůžeme.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h1 class="mb-4">Vítejte v <i class="fa fa-utensils text-primary me-2"></i>Restoran</h1>
                        <p class="mb-4">Již více než 15 let přinášíme našim hostům nezapomenutelné kulinářské zážitky. Naše restaurace se zaměřuje na kombinaci čerstvých surovin a originálních receptů, které dělají každý pokrm jedinečným. Těšíme se, až vás přivítáme a nabídneme vám atmosféru, která pohladí nejen chuťové buňky, ale i duši.</p>
                        <p class="mb-4">Naši šéfkuchaři, kteří patří mezi špičku ve svém oboru, dbají na každý detail a s láskou připravují každé jídlo. Jejich talent a zkušenosti jsou základem našich pokrmů, které spojují tradici s moderní kuchyní. Přijďte ochutnat a objevte skutečnou vášeň pro vaření.</p>
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center border-start border-5 border-primary px-3">
                                    ...
                                    <div class="ps-4">
                                        <p class="mb-0">Populárních</p>
                                        <h6 class="text-uppercase mb-0">šéfkuchařů</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a class="btn btn-primary py-3 px-5 mt-2" href="{{ route('menus.index') }}">Menu</a>
                    </div>
                </div>
            </div>
        </div>
